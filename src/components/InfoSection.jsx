            ...
            >
                <div className="p-2 bg-white absolute top-[10%] h-[36%] w-[36%] -translate-x-[50%] rounded-lg">
                    <div
                        ...
                        style={{ backgroundImage: `url(${sm_left})`, backgroundSize:'100% 100%' }}
                    ></div>
                </div>
                <div className="p-2 bg-white absolute bottom-[10%] h-[36%] w-[36%] right-0 translate-x-[50%] rounded-lg">
                    <div
                        ...
                        style={{ backgroundImage: `url(${sm_right})`, backgroundSize:'150% 100%' }}
                    ></div>
                </div>
            </div>
            <div className="space-y-4 max-w-screen">
                <h2 className="font-semibold leading-tight text-[36px] max-w-[32rem]">
                    Les meilleurs espaces de travail créatifs adaptés à vos
                    besoins.
                </h2>
                <p className="font-light">
                    Des sièges ergonomiques et des bureaux spacieux garantissent
                    votre bien-être tout au long de la journée, tandis qu'une
                    ambiance chaleureuse et lumineuse favorise la concentration
                    et la créativité.
                </p>
                    ...
                    <li>
                        <div className="flex flex-row gap-6">
                            <div className="bg-primary h-14 w-14 rounded-2xl p-[0.8rem] shrink-0">
                                <img src={ic_clock_icon} className="w-full h-full translate-x-[0.125rem]" />
                            </div>
                            <div>
                                <h2 className="font-bold ">
                                    Ouvert de 7h45 à minuit
                                </h2>
                                <p className="font-light">
                                    Travaillez à votre rythme chez Hippocrate,
                                    un espace de coworking confortable et
                                    productif, toute la journée jusqu'à minuit.
                                </p>
                            </div>
                        </div>
                    </li>
